...
<body>
    <header>
        <nav  class="navBarContainer">
            <div>
                <section class="navbar w-10   bg-light d-flex flex-row  justify-content-evenly ">
                    <div >
                    ...
                    <a class="btn   btn-md rounded-3 btn-dark" href="logout.php">log out</a>
    ...
    <main>
        <section class='w-100  text-center mt-4'>
            <h1 class='.text-dark t-align'>Employees Management</h1>
        </section>
        <section>
            <div class='container mt-5 mb-5 w-100 '>
                <a class="btn btn-dark" onclick='show()'>Add new Employee</a> 
                <a class=" ps-3 btn btn-dark  rounded-3 border-1" href="search.php ">Search Employee</a>
                    ...
                    <div id="closeMark" class="close cursor-pointer float-end fs-3 	 me-4   " onclick="hide()">x</div>
                        ...
                        <div class="formContainer ms-auto me-auto pt-1 pb-2 ">
                            <form method="post" enctype="multipart/form-data"  >
                                ...
                                <input class="    buttonAdd btn-md d-block btn btn-dark mt-2 mb-2  " type="submit"  value ="Add Employee">
                            </form>
                            </div>
                        </div>
            ...
            ?>
                <div class="tableElements mt-2">
                    <tr>
                        ...
                        <td><a class= ' mt-2 mb-2  btn btn-dark' id="buttonEdit" " href="edit.php?id=<?php echo $employee->getId() ?>" >edit</a></td>
